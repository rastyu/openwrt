...
# 个人定制编译Openwrt固件仓库
<a href="https://github.com/rastyu/s905x3-openwrt/releases/tag/x86_64"><img src="https://img.shields.io/badge/openwrt-LEDE_x86_精简-D98719"></a>
...
| 配置 | 说明 |  
| ---- | ---- | 
| RELEASES_TOKEN | 用于发布固件 |
| TELEGRAM_TO | 用于ssh自动发送链接到指定电报账户,进行远程修改config配置文件 |
| TELEGRAM__TOKEN | 用于ssh自动发送链接到指定电报账户,进行远程修改config配置文件明 |
