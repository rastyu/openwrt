...
svn co https://github.com/immortalwrt/luci/applications/luci-app-filebrowser package/luci-app-filebrowser
svn co https://github.com/immortalwrt/packages/utils/filebrowser package/filebrowser
